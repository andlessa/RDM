...
%We will also briefly discuss the future prospects of LHC and direct detection experiments to further probe the parameter space.
...
%\begin{itemize}
%%\item Discuss why only $(\lambda_{\sss L})_{33}$ and  $(\lambda_{\sss R})_{23} $ are needed. Explain why we did not choose the $L \leftrightarrow R$ case. 
%\item $D-\bar{D}$ mixing is Cabibbo-suppressed $\theta_c^3$ and by an extra chirality flip, so gives no meaningful bound
%\item $B_c \to \tau \nu$ and $Z \to \tau \tau$ also impact the parameter space
%\item present plot in the  $\lambda_L = 1 = \lambda_R$ plane for fixed $m_{S1}$ (1 TeV?). Similar to the one in Fig.~\ref{fig:marco}
%\item Present working points allowed: $(m_{S_1} [\rm{TeV}] ,\lambda_L,\lambda_R) = (1,0.6,0.5)$ and $(1.0, 0.06, 5.0)$.
%\end{itemize}
...
% \begin{figure}[!htp]
%  \centering
%  \includegraphics[width=0.5\textwidth]{yL_yR_by_Marco.png} 
%  \caption{\it Picture of the blackboard from QCD room.}
%\label{fig:marco}
%\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure}[!htp]
