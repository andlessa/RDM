...
df = pd.read_csv(efficiency_files+'i2HDM_double_output.dat',sep='\s+')
...
fig.tight_layout()
plt.savefig('i2HDM_efficiency_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('i2HDM_xslim_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('i2HDM_accepted_xs_points_table_double_channel.pdf')

with open('i2HDM_efficiency_double_channel.tex', 'w') as f:
   f.write(table_eff.to_latex())

with open('i2HDM_xslim_double_channel.tex', 'w') as f2:
