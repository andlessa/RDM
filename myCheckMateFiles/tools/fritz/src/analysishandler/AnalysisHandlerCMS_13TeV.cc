...
const double AnalysisHandlerCMS_13TeV::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerCMS_13TeV::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerCMS_13TeV::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerCMS_13TeV::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerCMS_13TeV::PTMIN_TAU_TRUTH = 1.0;

const double AnalysisHandlerCMS_13TeV::DR_B_TRUTH = 0.4;
const double AnalysisHandlerCMS_13TeV::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerCMS_13TeV::PTMIN_B_TRUTH = 1.0;


AnalysisHandlerCMS_13TeV::AnalysisHandlerCMS_13TeV() : AnalysisHandler() {
}

AnalysisHandlerCMS_13TeV::~AnalysisHandlerCMS_13TeV() {
}

void AnalysisHandlerCMS_13TeV::initialize() {
}

void AnalysisHandlerCMS_13TeV::finalize() {
}

void AnalysisHandlerCMS_13TeV::bookAnalysis(std::string analysisName,
                                      Tag_Map whichTags,
...
void AnalysisHandlerCMS_13TeV::postProcessParticles() {
...
void AnalysisHandlerCMS_13TeV::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerCMS_13TeV::identifyElectrons() {
...
void AnalysisHandlerCMS_13TeV::identifyMuons()  {
...
void AnalysisHandlerCMS_13TeV::tagBJets() {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerCMS_13TeV::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerCMS_13TeV::bBkgCJetEff;
                      break;
                  }
              }
          }
...
void AnalysisHandlerCMS_13TeV::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerCMS_13TeV::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerCMS_13TeV::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerCMS_13TeV::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerCMS_13TeV::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerCMS_13TeV::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerCMS_13TeV::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerCMS_13TeV::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerCMS_13TeV::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerCMS_13TeV::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerCMS_13TeV::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerCMS_13TeV::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerCMS_13TeV::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerCMS_13TeV::linkObjects() {
...
double AnalysisHandlerCMS_13TeV::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerCMS_13TeV::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerCMS_13TeV::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerCMS_13TeV::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerCMS_13TeV::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerCMS_13TeV::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS_13TeV::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerCMS_13TeV::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS_13TeV::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS_13TeV::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS_13TeV::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS_13TeV::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS_13TeV::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerCMS_13TeV::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS_13TeV::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerCMS_13TeV::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS_13TeV::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
////CMS medium
//	  const double c0 = 0.421;
//	  const double c1 = 0.0107;
...
double AnalysisHandlerCMS_13TeV::bBkgCJetRej(double eff) {
...
double AnalysisHandlerCMS_13TeV::bBkgLJetRej(double eff) {
...
double AnalysisHandlerCMS_13TeV::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerCMS_13TeV::muonDetector AnalysisHandlerCMS_13TeV::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
