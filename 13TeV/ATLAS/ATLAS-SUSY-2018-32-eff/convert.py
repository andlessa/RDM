...
TChiWW = {
'name' 		 : 'TChiWW',
'info' 		 :{'figure' 		: 'Fig.4a-16h',
			   'figureUrl' 		: 'https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-32/figaux_04a.png',
			   'dataUrl' 		: 'https://www.hepdata.net/record/ins1750597?version=1&table=Acceptance SR-SF-0J-[100,inf) for C1C1WW grid'},
...
mt2 = ['100,inf','160,inf','100,120','120,160']

TX 	  = TChiWW
obsN  = [[95,21,47,27],		[75,15,38,22],		[147,37,53,57],		[120,29,55,36]]
expN  = [[96,18.8,45,33],	[75,15.1,39,21.3],	[144,37.3,56,51],	[124,36,48,40]]
bgErr = [[15,2.4,9,5],		[9,2.7,6,2.8],		[12,3,6,5],			[12,5,8,4]]
'''
