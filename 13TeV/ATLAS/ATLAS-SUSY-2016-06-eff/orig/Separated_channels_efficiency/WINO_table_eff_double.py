...
df = pd.read_csv(efficiency_files+'MSSM_double_output.dat',sep='\s+')
...
fig.tight_layout()
plt.savefig('MSSM_efficiency_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('MSSM_xslim_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('MSSM_accepted_xs_points_table_double_channel.pdf')

with open('MSSM_efficiency_double_channel.tex', 'w') as f:
   f.write(table_eff.to_latex())

with open('MSSM_xslim_double_channel.tex', 'w') as f2:
