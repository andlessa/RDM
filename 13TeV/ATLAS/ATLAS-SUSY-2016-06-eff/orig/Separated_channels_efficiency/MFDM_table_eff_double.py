...
df = pd.read_csv(efficiency_files+'MFDM_double_output.dat',sep='\s+')
...
fig.tight_layout()
plt.savefig('MFDM_efficiency_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('MFDM_xslim_table_double_channel.pdf')
...
fig.tight_layout()
plt.savefig('MFDM_accepted_xs_points_table_double_channel.pdf')

with open('MFDM_efficiency_double_channel.tex', 'w') as f:
   f.write(table_eff.to_latex())

with open('MFDM_xslim_double_channel.tex', 'w') as f2:
