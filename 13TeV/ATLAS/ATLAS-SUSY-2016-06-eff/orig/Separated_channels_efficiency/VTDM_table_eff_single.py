...
df = pd.read_csv(efficiency_files+'VTDM_single_output.dat',sep='\s+')
...
fig.tight_layout()
plt.savefig('VTDM_efficiency_table_single_channel.pdf')
...
fig.tight_layout()
plt.savefig('VTDM_xslim_table_single_channel.pdf')
...
fig.tight_layout()
plt.savefig('VTDM_accepted_xs_points_table_single_channel.pdf')

with open('VTDM_efficiency_single_channel.tex', 'w') as f:
   f.write(table_eff.to_latex())

with open('VTDM_xslim_single_channel.tex', 'w') as f2:
