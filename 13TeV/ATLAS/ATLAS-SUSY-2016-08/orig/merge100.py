...
f=open("HEPData-ins1630632-v2-Table_19.csv" )
lines=f.readlines()
f.close()
data, expdata = {}, {}
...
files = { 1400: "HEPData-ins1630632-v2-Table_7.csv", 2000: "HEPData-ins1630632-v2-Table_8.csv" }
