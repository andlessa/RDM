...
dataset.setInfo(dataType = 'efficiencyMap', dataId = "3NJet6_800HT1000_450MHT600", observedN = 124, expectedBG = 108 , bgError = 15, upperLimit = '2.555E+00*fb', expectedUpperLimit = '1.881E+00*fb')
#+++++++ next txName block ++++++++++++++
...
dataset.setInfo(dataType = 'efficiencyMap', dataId = "3NJet6_800HT1000_600MHTinf", observedN = 52, expectedBG = 54.8 , bgError = 9.7, upperLimit = '1.181E+00*fb', expectedUpperLimit = '1.253E+00*fb')
#+++++++ next txName block ++++++++++++++
T2 = dataset.addTxName('T2')
T2.checked =''
T2.constraint ="[[['jet']],[['jet']]]"
