...
info = MetaInfoInput('ATLAS-SUSY-2013-99')
...
info.comment = 'First Home Made Eff Map'
...
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRA-mCT150.dat', 'txt', objectName = None, index = None, dataset="SRA-mCT150" )
...
T2bb_1.figureUrl =''
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRA-mCT200.dat', 'txt', objectName = None, index = None, dataset="SRA-mCT200" )
...
T2bb_1.figureUrl =''
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRA-mCT250.dat', 'txt', objectName = None, index = None, dataset="SRA-mCT250" )
...
T2bb_1.figureUrl =''
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRA-mCT300.dat', 'txt', objectName = None, index = None, dataset="SRA-mCT300" )
...
T2bb_1.figureUrl =''
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRA-mCT350.dat', 'txt', objectName = None, index = None, dataset="SRA-mCT350" )
...
T2bb_1.figureUrl =''
#----limit source----
T2bb_1.efficiencyMap.setSource( 'orig/MA5_EM_SRB.dat', 'txt', objectName = None, index = None, dataset="SRB" )
