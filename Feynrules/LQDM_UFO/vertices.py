...
V_48 = Vertex(name = 'V_48',
              ...
              couplings = {(0,0):C.GC_109,(0,1):C.GC_116})
...
V_51 = Vertex(name = 'V_51',
              ...
              couplings = {(0,0):C.GC_108,(0,1):C.GC_116})
...
V_57 = Vertex(name = 'V_57',
              ...
              couplings = {(0,0):C.GC_108,(0,1):C.GC_119})
...
V_164 = Vertex(name = 'V_164',
               particles = [ P.P__tilde__chi1__tilde__, P.P__tilde__chi1, P.a ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_1})

V_165 = Vertex(name = 'V_165',
               particles = [ P.a, P.LQ__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_2})

V_166 = Vertex(name = 'V_166',
               particles = [ P.P__tilde__chi0, P.P__tilde__chi1, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_149})

V_167 = Vertex(name = 'V_167',
               particles = [ P.P__tilde__chi1__tilde__, P.P__tilde__chi0, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_149})

V_168 = Vertex(name = 'V_168',
               particles = [ P.a, P.a, P.LQ__tilde__, P.LQ ],
               color = [ 'Identity(3,4)' ],
               lorentz = [ L.VVSS1 ],
...
V_169 = Vertex(name = 'V_169',
               ...
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_83,(0,1):C.GC_74})

V_170 = Vertex(name = 'V_170',
               particles = [ P.c, P.e__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_86,(0,1):C.GC_77})

V_171 = Vertex(name = 'V_171',
               particles = [ P.t, P.e__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_89,(0,1):C.GC_80})

V_172 = Vertex(name = 'V_172',
               particles = [ P.u, P.mu__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_84,(0,1):C.GC_75})

V_173 = Vertex(name = 'V_173',
               particles = [ P.c, P.mu__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_87,(0,1):C.GC_78})

V_174 = Vertex(name = 'V_174',
               particles = [ P.t, P.mu__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_90,(0,1):C.GC_81})

V_175 = Vertex(name = 'V_175',
               particles = [ P.u, P.ta__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_85,(0,1):C.GC_76})

V_176 = Vertex(name = 'V_176',
               particles = [ P.c, P.ta__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_88,(0,1):C.GC_79})

V_177 = Vertex(name = 'V_177',
               particles = [ P.t, P.ta__minus__, P.LQ__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_91,(0,1):C.GC_82})
...
V_179 = Vertex(name = 'V_179',
               particles = [ P.c__tilde__, P.e__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_77,(0,1):C.GC_86})

V_180 = Vertex(name = 'V_180',
               particles = [ P.t__tilde__, P.e__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_80,(0,1):C.GC_89})

V_181 = Vertex(name = 'V_181',
               particles = [ P.u__tilde__, P.mu__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_75,(0,1):C.GC_84})

V_182 = Vertex(name = 'V_182',
               particles = [ P.c__tilde__, P.mu__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_78,(0,1):C.GC_87})

V_183 = Vertex(name = 'V_183',
               particles = [ P.t__tilde__, P.mu__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_81,(0,1):C.GC_90})

V_184 = Vertex(name = 'V_184',
               particles = [ P.u__tilde__, P.ta__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_76,(0,1):C.GC_85})

V_185 = Vertex(name = 'V_185',
               particles = [ P.c__tilde__, P.ta__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_79,(0,1):C.GC_88})

V_186 = Vertex(name = 'V_186',
               particles = [ P.t__tilde__, P.ta__plus__, P.LQ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
...
V_188 = Vertex(name = 'V_188',
               particles = [ P.vm__tilde__, P.d__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_54})

V_189 = Vertex(name = 'V_189',
               particles = [ P.vt__tilde__, P.d__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_55})

V_190 = Vertex(name = 'V_190',
               particles = [ P.ve__tilde__, P.s__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_56})

V_191 = Vertex(name = 'V_191',
               particles = [ P.vm__tilde__, P.s__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_57})

V_192 = Vertex(name = 'V_192',
               particles = [ P.vt__tilde__, P.s__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_58})

V_193 = Vertex(name = 'V_193',
               particles = [ P.ve__tilde__, P.b__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_59})

V_194 = Vertex(name = 'V_194',
               particles = [ P.vm__tilde__, P.b__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_60})

V_195 = Vertex(name = 'V_195',
               particles = [ P.vt__tilde__, P.b__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_61})

V_196 = Vertex(name = 'V_196',
               particles = [ P.ve, P.d, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_62})

V_197 = Vertex(name = 'V_197',
               particles = [ P.vm, P.d, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_63})

V_198 = Vertex(name = 'V_198',
               particles = [ P.vt, P.d, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_64})

V_199 = Vertex(name = 'V_199',
               particles = [ P.ve, P.s, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_65})

V_200 = Vertex(name = 'V_200',
               particles = [ P.vm, P.s, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_66})

V_201 = Vertex(name = 'V_201',
               particles = [ P.vt, P.s, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_67})

V_202 = Vertex(name = 'V_202',
               particles = [ P.ve, P.b, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_68})

V_203 = Vertex(name = 'V_203',
               particles = [ P.vm, P.b, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_69})

V_204 = Vertex(name = 'V_204',
               particles = [ P.vt, P.b, P.LQ__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_70})

V_205 = Vertex(name = 'V_205',
               particles = [ P.P__tilde__chi1__tilde__, P.P__tilde__chi1, P.g ],
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_14})

V_206 = Vertex(name = 'V_206',
               particles = [ P.g, P.LQ__tilde__, P.LQ ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_13})

V_207 = Vertex(name = 'V_207',
               particles = [ P.a, P.g, P.LQ__tilde__, P.LQ ],
               color = [ 'T(2,4,3)' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_15})

V_208 = Vertex(name = 'V_208',
               particles = [ P.g, P.g, P.LQ__tilde__, P.LQ ],
...
V_210 = Vertex(name = 'V_210',
               particles = [ P.Z, P.LQ__tilde__, P.LQ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_117})

V_211 = Vertex(name = 'V_211',
               particles = [ P.a, P.Z, P.LQ__tilde__, P.LQ ],
               color = [ 'Identity(3,4)' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_120})

V_212 = Vertex(name = 'V_212',
               particles = [ P.g, P.Z, P.LQ__tilde__, P.LQ ],
               color = [ 'T(1,4,3)' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_121})

V_213 = Vertex(name = 'V_213',
               particles = [ P.Z, P.Z, P.LQ__tilde__, P.LQ ],
               color = [ 'Identity(3,4)' ],
               lorentz = [ L.VVSS1 ],
